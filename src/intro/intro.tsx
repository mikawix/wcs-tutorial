...
export const Intro: React.FC = () => {
    return (
        <div className='intro'>
            ...
            <IntroRectangle backgroundColor="#FF5B2B" left={26} top={270} size="medium" shape="ellipse" angle={17} zIndex={2} />
            <IntroRectangle backgroundColor="#FA9DBC" left={38} top={300} shape="ellipse" size="medium" angle={-17} zIndex={1} />
            <IntroRectangle backgroundColor="#DCD9BF" shape="ellipse" size="large" left={114} top={310} angle={-28} />
